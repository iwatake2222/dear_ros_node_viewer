...
def caret2networkx(filename: str, target_path: str = 'all_graph',
           ...
           display_unconnected_topics=False) -> nx.classes.multidigraph.MultiDiGraph:
  """
